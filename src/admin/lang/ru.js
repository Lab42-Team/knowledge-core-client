export default {
    ...
    PAGE: {
        ...
        PROJECTS: {
            ...
            VIEW_USER: 'Просмотр пользователя проекта',
            EDIT_TEAM: 'Редактирование команды проекта',
        },
        USERS: {
            NAME: 'Пользователи',
    ...
    CONFIRM: {
        ...
        PROJECTS: {
            ...
            EXCLUDE_USER: 'Вы уверены, что хотите исключить пользователя из этого проекта?',
        },
        USERS: {
    ...
    MESSAGE: {
        ...
        PROJECTS: {
            ...
            SUCCESS: {
                ...
                TEAM_UPDATED: 'Команда проекта изменена!',
                EXCLUDE_USER: 'Пользователь успешно исключен!',
            },
            ERROR: {
